...
- **B — Correct.** USFWS NWI polygons represent USACE-regulated wetlands at the desktop-identification level. Crossing a mapped wetland requires USACE Section 404 permit review (Nationwide Permit 12 for most OSP utility crossings, subject to conditions). NWP 12 carries a 0.1-acre fill limit per crossing and has experienced regional suspensions in certain USACE districts; confirm current availability with the applicable USACE district office before building the project schedule around it. Stream crossings may additionally require Section 10 review for navigable waters. Both should be flagged as fatal-flaw candidates during desk research, and project scheduling should account for the permit timeline. [BICSI OSP-DRD Manual, Ch. 3; FHWA utility accommodation policy guidance]
