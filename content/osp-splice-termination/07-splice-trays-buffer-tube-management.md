...
2. Apply a gel removal solvent or isopropyl alcohol (IPA) on fresh lint-free wipes; wipe from the tube breakout point toward the fiber tips, not back-and-forth (which re-deposits gel).
...
- **No tight bends on tubes.** The buffer tube itself has a minimum bend radius specification — typically 10× the tube outer diameter (a 2 mm tube has a 20 mm minimum bend radius, separate from the 30 mm fiber radius inside the tube).
