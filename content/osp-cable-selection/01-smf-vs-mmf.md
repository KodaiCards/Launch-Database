...
OS2 is the correct selection for this application. At 1550 nm, OS2 achieves typical attenuation of 0.18–0.20 dB/km [ITU-T G.652.D §4]. Over a 48 km span with three splice points (budget ~0.1 dB/splice for fusion splices [BICSI OSP-DRD Manual, Ch. 7.4]), total optical loss is approximately 9.6–9.8 dB — within the power budget of 10GBASE-ER transceivers (loss budget: 12.6 dB per IEEE 802.3ae). Note: 48 km marginally exceeds the 40 km nominal reach of 10GBASE-ER; a well-provisioned OS2 plant at the low end of its attenuation range (≤0.20 dB/km) will remain within budget, but routes approaching the limits of ER reach may require ZR optics or inline optical amplification. 10GBASE-LR (loss budget: 6.3 dB, 10 km max) cannot be used on this span. The fiber plant supports future transceiver upgrades to 40G ER4 or 100G ER4 without fiber replacement. ANSI/TIA-758-C §5.2 specifies OS2 for OSP feeder cable, satisfying the RUS compliance requirement. Capital cost for the fiber plant is optimized: OS2 is comparable in per-foot price to OM4 for typical strand counts, and the long-term upgrade path eliminates future fiber costs.
