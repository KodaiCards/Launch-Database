...
- **(d) Budgets redesign+port** [#4] — needs a design pass WITH Carter (he wants rework). Ties into the projection budget overlay (currently uses existing EC budget total).
