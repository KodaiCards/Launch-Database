...
| T12 | Testing — OLTS, OTDR, Inspection | General | ⏳ RESEARCH COMPLETE → authoring in queue | R-1 `7e2f526` (primary-source-skeptical, 15 lessons). R-2 `1592bd3` (corroboration-adversarial). Convergence: 5 corroborated; 3 corrections (IEC 61300-3-35 Zone B 120→110 µm + C/D removed from mandatory; OTDR error reframe whole-link ~0.25 dB not per-event; PMD G.652.D 0.2 ps/√km not 0.5); 4 new content items (VFL Tier-0, OLTS ref-cord verify, multi-reel IOR, 1310+1550 nm dual-λ acceptance baseline). Author dispatch next. |
