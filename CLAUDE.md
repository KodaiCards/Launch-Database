...
**OSP-RW.3 Template Topic (T02 Fiber Physics)** — IN FLIGHT overnight 2026-05-15→16. Author agent + RT to land before Carter wakes. T02 chosen as template because it's the foundational DAG-near-root topic with the richest existing source content (M01_FiberPhysics.jsx 349 LOC + LinkBudgetCalculator component to embed) — sets the gold standard for OSP-RW.4 authoring waves on the other 21 topics.
