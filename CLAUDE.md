...
| T12 | Testing — OLTS, OTDR, Inspection | General | ⏳ AUTHORED `4397def` → RT-α + RT-β dispatch next | R-1 `7e2f526` + R-2 `1592bd3`. Author `4397def` — 15 lessons L01-L15, 4699 lines, Vite build clean. All R-2 corrections applied: Zone B 110 µm, ~0.25 dB whole-link OTDR bias, G.652.D PMD 0.2 ps/√km. 25-Q capstone. RT pair (pedagogy + technical/math) required before CLOSED. |
