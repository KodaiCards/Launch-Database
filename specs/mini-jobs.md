...
## The model
1. **The Job Board page** — open jobs (grouped county-first, law §7) sit claimable. An employee **picks up a job** → becomes its owner, inherits all its mini-jobs onto **My Work**. Jobs can also be picked at creation (add project → pick your job).
