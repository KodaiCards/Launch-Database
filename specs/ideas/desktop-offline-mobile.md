...
> **Carter (verbatim, same night):** "What about an app where they sign on and keep it running the whole time they are working, when they save and close an autocad program it brings up a prompt that says mark XXX complete? That'd require a list each employee sees with their workload and each jobs mini jobs. you make the mini jobs complete"
