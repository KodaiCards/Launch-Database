      ...
      <section data-tier="advanced">
        ...
        <section className="mt-8 p-5 border-l-4 border-blue-500 bg-slate-800/40 rounded">
          ...
          <ul className="space-y-2 text-slate-300 text-sm list-disc ml-5">
            ...
            <li><strong>Messenger Bonding Rules</strong> — Every metallic armor at a pole attachment (aerial) or splitter (underground) requires bonding to ground per NEC 770.48 and RUS 1753.18. Dielectric cable completely avoids this cost and labor; metallic armor adds recurring work.</li>
          </ul>
