  ...
  return (
    <LessonLayout meta={meta}>
      ...
      <section data-tier="foundations">
        ...
        <p>
          From Fiber Physics, you know that bending a fiber too sharply causes light to escape from
      ...
      <section data-tier="advanced">
        ...
        <p>
          The fiber-type choice you make here directly drives downstream design phases you'll learn in the OSP Design — Underground topic (conduit sizing) and the Splicing topic (fusion splicing compatibility). Here's why this matters: Fiber Physics taught you that macrobend loss is the enemy, especially at 1550 nm. Using the cable-level installation (dynamic-pull) rule from Cable Specification Reading — Real Datasheet — roughly 20&times; the cable's outer diameter — a typical 12 mm OSP cable containing G.652.D fiber has an installation-pull minimum bend radius of roughly 240 mm (9.5 inches). This is a distinct figure from the ~30 mm bare-fiber long-term bend-radius convention cited elsewhere in this lesson (and in the graded quiz below) — the 240 mm number applies to the whole cable during the dynamic stress of pulling, while the ~30 mm figure is an industry-convention long-term/loaded bend-radius reference for the bare fiber itself, not the installed cable. Don't confuse the two: they answer different questions (safe pulling radius for this cable vs. long-term bare-fiber bend tolerance) and are not interchangeable. See Cable Specification Reading — Real Datasheet for the general installation-vs-long-term bend radius distinction (installation number is larger/less restrictive; long-term is smaller). That's fine for a straight aerial span or a gently curved burial run. But what happens when an OSP feeder cable has to make a 90-degree turn inside a conduit at a distribution handhole? Or when a fiber drop cable has to make a 5 mm radius turn inside a building?
        </p>
        <p className="mt-2">
        ...
        <section className="mt-8 p-5 border-l-4 border-blue-500 bg-slate-800/40 rounded">
          ...
          <ul className="space-y-2 text-slate-300 text-sm list-disc ml-5">
            ...
            <li><strong>Core-Align vs. Cladding-Align</strong> — G.657.B3 has a slightly different MFD than G.652.D. When splicing mixed cable types (legacy G.652 + new G.657 at a distribution point), you must measure each splice; the trench-assisted profile changes attenuation by up to 0.1 dB per splice.</li>
