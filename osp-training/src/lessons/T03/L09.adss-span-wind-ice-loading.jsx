      ...
      <section data-tier="advanced">
        ...
        <section className="mt-8 p-5 border-l-4 border-blue-500 bg-slate-800/40 rounded">
          ...
          <ul className="space-y-2 text-slate-300 text-sm list-disc ml-5">
            <li><strong>Loading Districts — Rule 250</strong> — Light / Medium / Heavy districts define design wind speed (88 / 100 / 120 mph) and ice load (0.5 / 1.0 / 2.0 in). Your ADSS cable choice must match the district. Heavy-district ADSS requires heavier strength members or shorter spans than Light-district ADSS.</li>
            <li><strong>Pole Loading — Forces on a Pole</strong> — ADSS span tensioning (determined by wind/ice loads) feeds into pole selection. The pole must support the cable tension PLUS all the guys and other cables. Wrong load assumption = under-specified pole = failure risk.</li>
            <li><strong>OSP Design — Aerial</strong> — High-EDS ADSS in windy/icy regions requires multiple guys on certain poles. Load analysis determines how many guys and at what angles. Under-guying = cable sag increase + potential splice-closure movement.</li>
          </ul>
