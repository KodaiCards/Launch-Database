// Net-new — T06.L09 NESC Underground Rules §34, §35
...
// Communication/supply separation via Rules 320, 353, 354 within those sections.
...
export const meta = {
  id: 'T06.L09',
  course_id: 'T06',
  title: 'NESC Underground Rules — §34 and §35',
  order: 9,
  ...
  learning_objectives: [
    'Distinguish the four NESC underground sections by location type (conduit system, supply cable, underground structures, direct-buried/duct)',
    'Explain how §34 and §35 govern both supply and communication cables based on installation location, not cable type alone',
    'Apply supply-to-communication separation rules from NESC Rules 320, 353, and 354 for underground crossings and parallel runs',
  ...
  key_terms: [
    {
      term: 'NESC §34',
      definition: 'The section of the National Electrical Safety Code (NESC C2 [confirm edition]) titled "Cable in Underground Structures." §34 covers both electric supply cables and communication cables installed inside underground structures — manholes, handholes, and conduit systems that form enclosed underground spaces. The key distinction from §35: §34 applies when cables are in an enclosed structure, while §35 applies when cables are in the open earth (direct-buried or in duct not part of a conduit system).',
    },
    {
      term: 'NESC §35',
      definition: 'The section of the NESC (C2 [confirm edition]) titled "Direct-Buried Cable and Cable in Duct Not Part of a Conduit System." §35 applies to both supply and communication cables installed directly in the earth or in duct outside of an underground conduit system. This is the primary NESC section governing most OSP fiber underground construction — including direct-buried fiber drops, conduit runs in open trenches or bores that are not enclosed underground structures, and innerduct installations. §35 sets minimum cover depths, separation requirements, and marking rules.',
    },
    {
      term: 'supply-communication separation',
      definition: 'The minimum horizontal or vertical distance required between an electric supply cable and a communication cable when they are installed underground in the same corridor. Within NESC §35, separation between supply and communication facilities is governed by Rules 320, 353, and 354. Two situations: (1) crossing — supply and communication cross each other at approximately 90°; (2) parallel run — supply and communication run alongside each other in the same trench or corridor. Separation values differ by situation and cable installation type.',
    },
    {
  ...
  return (
    <LessonLayout meta={meta}>
      ...
      <section data-tier="foundations">
        ...
        <p className="mt-2">
          The NESC has four sections for underground work. The key distinction is
          <strong> location type</strong> — where the cable is installed — not simply whether
          it's a supply or communication cable:
        </p>
        <ul className="list-disc pl-5 space-y-2 mt-2 text-slate-300/90">
          <li>
            <strong>§32 — Underground Conduit Systems</strong> (supply infrastructure, e.g.,
            supply cable in conduit systems). Primarily supply-infrastructure focus.
          </li>
          <li>
            <strong>§33 — Supply Cable</strong> (supply cables in various underground locations).
          </li>
          <li>
            <strong>§34 — Cable in Underground Structures</strong> (manholes, handholes,
            and enclosed conduit systems — applies to <em>both</em> supply and communication
            cables inside those structures).
          </li>
          <li>
            <strong>§35 — Direct-Buried Cable and Cable in Duct Not Part of a Conduit System</strong>
            (open-earth or open-duct installation — applies to <em>both</em> supply and
            communication cables). This is the primary NESC section for most OSP fiber
            underground construction.
          </li>
        </ul>
        <p className="mt-2">
          For OSP designers: <strong>§35 is the section you use most.</strong> It covers
          fiber in open-trench conduit, bored conduit, and direct-buried drops — the
          bread-and-butter of residential and rural underground fiber builds. §34 applies
          when your cable enters a manhole or enclosed conduit structure.
          Supply-to-communication separation within these sections is governed by
          Rules 320, 353, and 354.
        </p>
      ...
      <section data-tier="working">
        <h2>NESC §34 and §35 — What They Actually Require</h2>

        <h3 className="mt-4 font-semibold">§34: Cable in underground structures</h3>
        <p>
          NESC §34 applies to cables inside enclosed underground structures — manholes,
          handholes, and conduit systems that form enclosed underground spaces. Both electric
        ...
        <p>
          NESC §35 is the primary section for most OSP fiber underground construction. It applies
          when your fiber cable is either (a) direct-buried in the earth (no conduit) or (b) inside
          a conduit or duct that is not part of an enclosed underground conduit system. This includes:
        </p>
        <ul className="list-disc pl-5 space-y-1 mt-2 text-slate-300/90">
          <li>Open-trench conduit installations</li>
          <li>HDD-bored conduit runs</li>
          <li>Direct-buried service drops (fiber from distribution pedestal to the home)</li>
        ...
        <ul className="list-disc pl-5 space-y-2 mt-2 text-slate-300/90">
          ...
          <li>
            <strong>Minimum cover for conduit/duct:</strong> 18 inches in most residential
            non-traffic areas. The conduit wall provides additional mechanical protection.
            Under roads: 24–36 inches.
            [confirm current NESC C2 §35 cover clause]
          </li>
          <li>
            <strong>Separation from electric supply at crossings (Rule 354):</strong> Where
            communication conduit crosses a supply cable or conduit, Rule 354 specifies minimum
            vertical separation. The conduit wall provides a physical barrier, which is why
            separation requirements for conduit are less restrictive than for direct-buried
            cable at the same crossing. A protective separation board is standard field practice
            even where Rule 354 doesn't strictly require it.
            [confirm current NESC C2 Rule 354 crossing separation values]
          </li>
          <li>
            <strong>Separation in parallel runs (Rule 354):</strong> When communication conduit
            runs parallel to electric supply in the same trench or corridor, Rule 354 specifies
            minimum horizontal separation. The most common design situation: fiber distribution
            routes sharing a road ROW with existing electric plant.
            [confirm current NESC C2 Rule 354 parallel separation values]
          </li>
          <li>
        ...
        <div className="mt-4 p-4 border border-amber-400/30 bg-amber-400/5 rounded-lg text-sm">
          ...
          <p className="text-slate-300/90">
            <strong>Book:</strong> NESC §35 / Rule 354 allows communication conduit and supply
            cable to be close at a crossing because the conduit reduces contact risk. [confirm
            current edition for exact minimum]
          </p>
          <p className="text-slate-300/90 mt-2">
            <strong>Field:</strong> Most RUS and utility-program field crews use 12 inches
            of vertical separation as a working minimum at crossings, regardless of the NESC
            floor. The reasoning: locates are not always accurate (±18-inch tolerance is typical
            for most locate services), and the bore crew can't see the existing supply cable.
            Running 12 inches instead of 6 inches at a crossing is cheap insurance. The extra
            6 inches costs nothing on a conduit bore — adjust the bore profile slightly.
          </p>
          <p className="text-slate-300/90 mt-2">
            <strong>The risk:</strong> If a designer assumes the code floor is sufficient and
            the bore crew doesn't have an accurate locate, the bore could run far closer to an
            unlabeled supply conductor than planned. A frac-out at that point could bring the
            drill bit into contact with the power cable — a potentially fatal utility strike.
            Designing to 12 inches as the minimum covers locate error tolerance and the NESC
        ...
        <p>
          NESC §35 requires that installed cable or conduit be documented so future excavators
          can locate it. The documentation chain includes:
        </p>
        <ol className="list-decimal pl-5 space-y-2 mt-2 text-sm">
          <li>
            <strong>Warning tape.</strong> Orange warning tape ("CAUTION —
            ...
            Color Code.) (Source: APWA Utility Color Code; CGA Best Practices v20.0.)
          </li>
          <li>
            ...
            intervals on the conduit exterior. This identifies the conduit when encountered
            during excavation — even years after installation.
          </li>
          <li>
      ...
      <section data-tier="advanced">
        ...
        <ul className="list-disc pl-5 space-y-1 mt-2 text-sm">
          ...
          <li>Communication conduit at the minimum allowable depth above the supply, with required separation (Rule 354) maintained</li>
        ...
        questions={[
          {
            id: 'T06-L09-Q1',
            type: 'mc',
            prompt: 'NESC §35 applies to which type of underground cable installation?',
            choices: [
              'Communication cables only — §35 is the comm-specific underground section',
              'Cables inside manholes, handholes, and enclosed conduit systems',
              'Both supply and communication cables installed directly in the earth or in duct not part of a conduit system',
          ...
          },
          {
            id: 'T06-L09-Q2',
            type: 'mc',
            prompt: 'A fiber cable is being pulled into an existing manhole on a metro distribution route. Which NESC section governs the separation and installation requirements for this cable inside the manhole?',
            choices: [
              'NESC §35 — because the cable is a communication cable',
              'NESC §32 — because the cable will be spliced inside the manhole',
              'NESC §34 — because the cable is in an underground structure (manhole)',
          ...
          },
          {
            ...
            answerIndex: 1,
            explanation: 'Warning tape is buried 6–12 inches above the conduit (much shallower than the conduit itself). If an excavator is digging and hits the tape, they see "CAUTION — COMMUNICATION CABLE BELOW" before the shovel or bucket reaches the actual conduit. The tape doesn\'t provide separation or electrical conductivity — it\'s a visual warning intercepting the excavation before it reaches the cable. (Source: APWA Utility Color Code; CGA Best Practices v20.0.)',
          },
          {
            id: 'T06-L09-Q5',
            type: 'mc',
            prompt: 'A designer is laying out an underground fiber route that will run parallel to an existing direct-buried electric supply cable for 400 feet in the same ROW corridor. Both are under a residential street ROW. Which NESC section and rule primarily governs the separation requirement for the fiber conduit?',
            choices: [
              'NESC §34 (Cable in Underground Structures) — because both cables are underground',
              'NESC §35 and Rule 354 — because the fiber conduit is in the open earth, not an enclosed structure',
              'NESC §32 (Underground Conduit Systems) — because this is a conduit installation',
