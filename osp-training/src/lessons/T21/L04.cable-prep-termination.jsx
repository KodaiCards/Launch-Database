...
export const meta = {
  ...
  vocabulary_assumed: [
    ...
    { term: 'fiber stripping', source_lesson_id: 'T01.L05' },
        ...
        questions={[
          {
            ...
            question: 'During cable jacket stripping, what critical component should you NOT cut?',
            options: [
              { id: 'a', text: 'The outer PVC' },
              { id: 'b', text: 'The water-blocking gel' },
              { id: 'c', text: 'The aramid (Kevlar) reinforcement threads', isCorrect: true },
              { id: 'd', text: 'The loose tube' },
            ],
            rationale: 'Cutting aramid threads weakens the cable. A calibrated cable stripper cuts only the jacket, protecting the internal elements.',
          },
          {
            id: 'T21.L04.Q2',
            type: 'multiple-choice',
            question: 'What is the acceptable angle tolerance for a cleaved fiber endface?',
            options: [
              { id: 'a', text: '±2°' },
            ...
            rationale: 'Endface angle must be within ±0.5° perpendicular to the fiber axis. Angles >1° cause significant insertion loss.',
          },
          {
            id: 'T21.L04.Q3',
            type: 'multiple-choice',
            question: 'A microscope inspection of a polished connector endface shows pits. What should you do?',
            options: [
              { id: 'a', text: 'Install it anyway; pits are cosmetic' },
              { id: 'b', text: 'Recleve the fiber and re-polish', isCorrect: true },
              { id: 'c', text: 'Replace the entire cable' },
              { id: 'd', text: 'Use a protective cap to cover the pits' },
            ],
            rationale: 'Pits cause light scattering and high loss. Recleaving and re-polishing removes them. If pits persist, the stripper may be damaged.',
          },
          {
            id: 'T21.L04.Q4',
            type: 'multiple-choice',
            question: 'What is the minimum return loss (RL) acceptance criterion for a singlemode connector in OSP?',
            options: [
              { id: 'a', text: '≥20 dB' },
              { id: 'b', text: '≥35 dB' },
              { id: 'c', text: '≥45 dB', isCorrect: true },
              { id: 'd', text: '≥55 dB' },
            ],
            rationale: 'IEC 61753-1 specifies ≥45 dB RL for singlemode connectors. Lower values indicate poor polishing or endface defects.',
          },
        ]}
      />
    </LessonLayout>
