        ...
        questions={[
          {
            id: 'T21.L03.Q1',
            type: 'mc',
            prompt: 'NESC Rule 234 specifies minimum clearance from power lines. For 0–750V, what is the typical vertical clearance on a joint-use pole?',
            choices: [
              '6 inches',
              '12 inches',
              '18 inches',
            ...
            answerIndex: 2,
            explanation: 'NESC Rule 235 specifies 18 inches vertical clearance for 0–750V circuits. This protects against power-line sag or fiber drop.',
          },
          {
            id: 'T21.L03.Q2',
            type: 'mc',
            prompt: 'What is the typical maximum pulling tension for OSP fiber during aerial installation on poles?',
            choices: [
              '200 lbs per strand',
              '350 lbs per strand',
              '500 lbs per strand',
            ...
            answerIndex: 2,
            explanation: '500 lbs is the typical maximum for aerial OSP cable. Exceeding this risks damage to the fiber and overloading pole hardware.',
          },
          {
            id: 'T21.L03.Q3',
            type: 'mc',
            prompt: 'Direct-buried fiber is typically buried at what depth in areas with no heavy machinery traffic?',
            choices: [
              '6–12 inches',
              '18–24 inches',
              '30–36 inches',
            ...
            answerIndex: 1,
            explanation: 'Standard depth is 18–24 inches in low-risk areas. Deeper burial (30+ inches) is required where heavy equipment operates.',
          },
          {
            id: 'T21.L03.Q4',
            type: 'mc',
            prompt: 'What is the main advantage of conduit-based underground installation over direct-burial?',
            choices: [
              'Lower initial cost',
              'Faster installation',
              'Easier future fiber replacement without excavation',
              'Shallower burial depth allowed',
            ],
            answerIndex: 2,
            explanation: 'Conduit allows the fiber to be pulled out and replaced if damaged, avoiding full excavation and disruption.',
          },
        ]}
      />
    </LessonLayout>
