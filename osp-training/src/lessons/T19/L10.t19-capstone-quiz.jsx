// T19.L10 — T19 Capstone Quiz: Headend / CO + Rack-Side Hardware Basics
// lesson_type: capstone-quiz — NO Flashcard required per schema.md
...
export const meta = {
  id: 'T19.L10',
  course_id: 'T19',
  title: 'T19 Capstone Quiz — Headend / CO + Rack-Side Hardware',
  order: 10,
  ...
  vocabulary_assumed: [
    ...
    { term: 'IDF', source_lesson_id: 'T19.L01' },
    ...
    { term: 'CMTS', source_lesson_id: 'T19.L02' },
    { term: 'GPON port', source_lesson_id: 'T19.L02' },
    { term: 'upstream', source_lesson_id: 'T19.L02' },
    { term: 'downstream', source_lesson_id: 'T19.L02' },
    { term: 'DOCSIS', source_lesson_id: 'T19.L02' },
    { term: 'line card', source_lesson_id: 'T19.L02' },
    { term: 'chassis', source_lesson_id: 'T19.L02' },
    { term: 'port density', source_lesson_id: 'T19.L02' },
    { term: '–48VDC', source_lesson_id: 'T19.L03' },
    { term: 'rectifier', source_lesson_id: 'T19.L03' },
    { term: 'battery string', source_lesson_id: 'T19.L03' },
    { term: 'float voltage', source_lesson_id: 'T19.L03' },
    { term: 'distribution bus', source_lesson_id: 'T19.L03' },
    { term: 'VRLA', source_lesson_id: 'T19.L03' },
    { term: 'battery return', source_lesson_id: 'T19.L03' },
    { term: 'power plant', source_lesson_id: 'T19.L03' },
    { term: 'ATS', source_lesson_id: 'T19.L04' },
    { term: 'generator', source_lesson_id: 'T19.L04' },
    { term: 'runtime', source_lesson_id: 'T19.L04' },
    { term: 'transfer time', source_lesson_id: 'T19.L04' },
    { term: 'load test', source_lesson_id: 'T19.L04' },
    { term: 'fuel polishing', source_lesson_id: 'T19.L04' },
    { term: 'alarm threshold', source_lesson_id: 'T19.L04' },
    { term: 'CRAC', source_lesson_id: 'T19.L05' },
    { term: 'sensible heat', source_lesson_id: 'T19.L05' },
    { term: 'clean-agent suppression', source_lesson_id: 'T19.L05' },
    { term: 'pre-action sprinkler', source_lesson_id: 'T19.L05' },
    { term: 'ASHRAE thermal envelope', source_lesson_id: 'T19.L05' },
    { term: 'heat load', source_lesson_id: 'T19.L05' },
    { term: 'primary protector', source_lesson_id: 'T19.L06' },
    { term: 'IBT-entry', source_lesson_id: 'T19.L06' },
    { term: 'GES-tie-in', source_lesson_id: 'T19.L06' },
    { term: 'TMGB', source_lesson_id: 'T19.L06' },
    { term: 'TGB', source_lesson_id: 'T19.L06' },
    { term: 'TBB', source_lesson_id: 'T19.L06' },
    { term: 'GPR', source_lesson_id: 'T19.L06' },
    { term: 'patch panel', source_lesson_id: 'T19.L07' },
    { term: 'LIU', source_lesson_id: 'T19.L07' },
    { term: 'interconnect', source_lesson_id: 'T19.L07' },
    ...
    { term: 'rack-mount FOSC', source_lesson_id: 'T19.L08' },
    { term: 'express fiber', source_lesson_id: 'T19.L08' },
    { term: 'split fiber', source_lesson_id: 'T19.L08' },
    { term: 'gel-free splice enclosure', source_lesson_id: 'T19.L08' },
    { term: 'organizer tray', source_lesson_id: 'T19.L08' },
    { term: 'FDH', source_lesson_id: 'T19.L09' },
    { term: 'modular bay', source_lesson_id: 'T19.L09' },
    { term: 'splitter cassette', source_lesson_id: 'T19.L09' },
    { term: 'connector field', source_lesson_id: 'T19.L09' },
...
// ── Annotated Diagram — Headend Signal Chain ───────────────────────────────

const signalChainHotpoints = [
  {
    id: 'hp-olt',
    x: 8,
    y: 50,
    label: 'OLT',
    explanation: 'Optical Line Terminal in the headend rack. Transmits GPON downstream at 1490 nm; receives upstream at 1310 nm. Source of the optical signal for all subscriber paths.',
  },
  {
    id: 'hp-odf',
    x: 22,
    y: 50,
    label: 'ODF / LIU',
    explanation: 'Optical Distribution Frame or Line Interface Unit. The OLT trunk fiber terminates here via SC/APC pigtails. Cross-connect jumpers or interconnect cables route the signal to the feeder cable splice organizer.',
  },
  {
    id: 'hp-fosc-headend',
    x: 38,
    y: 50,
    label: 'Headend FOSC',
    explanation: 'Rack-mount or wall-mount Fiber Optic Splice Closure in the equipment room. OSP feeder cable is bonded and managed here. Express fibers pass through; split fibers are broken out to the ODF. Gel-free construction required indoors.',
  },
  {
    id: 'hp-fdh',
    x: 62,
    y: 50,
    label: 'FDH',
    explanation: 'Fiber Distribution Hub in the field. Feeder cable arrives, express fibers continue, split fibers feed splitter cassettes. Subscriber drop fibers plug into the connector field at the cassette output face.',
  },
  {
    id: 'hp-ont',
    x: 88,
    y: 50,
    label: 'ONT (demarc)',
    explanation: 'Optical Network Terminal at the subscriber premises. The demarc between carrier network and customer equipment. Drop fiber connects here. ONT converts optical signal to Ethernet for the subscriber\'s router.',
  },
];

const signalChainSvg = (
  <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style={{ background: '#f5f7fa', width: '100%', height: 'auto' }}>
    {/* Main fiber path */}
    <line x1="5" y1="50" x2="95" y2="50" stroke="#4a7eb5" strokeWidth="1.5" strokeDasharray="none" />
    {/* OLT */}
    <rect x="2" y="38" width="12" height="24" rx="2" fill="#2255aa" />
    <text x="8" y="52" fontSize="4.5" fill="#fff" textAnchor="middle">OLT</text>
    {/* ODF */}
    <rect x="16" y="40" width="12" height="20" rx="2" fill="#5588cc" />
    <text x="22" y="52" fontSize="4" fill="#fff" textAnchor="middle">ODF</text>
    {/* FOSC headend */}
    <rect x="30" y="40" width="16" height="20" rx="2" fill="#7aaad4" />
    <text x="38" y="49" fontSize="3.5" fill="#fff" textAnchor="middle">FOSC</text>
    <text x="38" y="54" fontSize="3" fill="#fff" textAnchor="middle">(headend)</text>
    {/* OSP segment arrow */}
    <text x="50" y="44" fontSize="3" fill="#666" textAnchor="middle">feeder cable (OSP)</text>
    {/* FDH */}
    <rect x="55" y="38" width="14" height="24" rx="2" fill="#4a9b4a" />
    <text x="62" y="52" fontSize="4.5" fill="#fff" textAnchor="middle">FDH</text>
    {/* Drop */}
    <text x="79" y="44" fontSize="3" fill="#666" textAnchor="middle">drop fiber</text>
    {/* ONT */}
    <rect x="84" y="40" width="12" height="20" rx="2" fill="#b07a20" />
    <text x="90" y="49" fontSize="3.5" fill="#fff" textAnchor="middle">ONT</text>
    <text x="90" y="54" fontSize="3" fill="#fff" textAnchor="middle">(demarc)</text>
    {/* Ground symbol at headend */}
    <line x1="38" y1="60" x2="38" y2="68" stroke="#888" strokeWidth="0.8" />
    <line x1="34" y1="68" x2="42" y2="68" stroke="#888" strokeWidth="0.8" />
    <line x1="35" y1="70" x2="41" y2="70" stroke="#888" strokeWidth="0.8" />
    <line x1="36" y1="72" x2="40" y2="72" stroke="#888" strokeWidth="0.8" />
    <text x="38" y="78" fontSize="2.5" fill="#888" textAnchor="middle">TMGB</text>
    {/* Power symbol at headend */}
    <rect x="2" y="65" width="12" height="10" rx="1" fill="#cc8800" />
    <text x="8" y="72" fontSize="2.8" fill="#fff" textAnchor="middle">–48VDC</text>
  </svg>
);

// ── Battery Sizing WorkedExample ───────────────────────────────────────────

const batterySizingExample = {
  title: 'Capstone Battery Sizing — Before the Quiz',
  description:
    'A remote hut (OLT + two CMTS chassis) has a measured DC load of 22 A at –48 VDC. The RUS-program design requires 8 hours of battery reserve. The battery string will be de-rated to 0.80 (80%) to account for aging and temperature. Calculate the minimum Ah capacity of the battery string.',
  variables: [
    { key: 'load_a', label: 'DC load', units: 'A', default: 22, min: 5, max: 100, step: 1 },
    { key: 'reserve_h', label: 'Required reserve time', units: 'hours', default: 8, min: 1, max: 24, step: 1 },
    { key: 'derate', label: 'De-rating factor', units: '', default: 0.80, min: 0.50, max: 1.00, step: 0.05 },
  ],
  ...
  steps: [
    'Step 1 — Raw energy needed: Raw Ah = Load (A) × Reserve time (h) = 22 A × 8 h = 176 Ah',
    'Step 2 — Apply de-rating: Sized Ah = Raw Ah ÷ De-rating factor = 176 Ah ÷ 0.80 = 220 Ah',
    'Step 3 — Select battery string: Specify a battery string rated ≥ 220 Ah at the 8-hour discharge rate (C8). Common VRLA sizes are 100 Ah, 150 Ah, 200 Ah, and 250 Ah per jar. Two 125 Ah jars in parallel = 250 Ah → meets the 220 Ah minimum.',
    'Sanity check: 220 Ah means you can draw 22 A for 10 hours on a fully charged string — but with 8-hour reserve plus 20% aging margin, this is the correct design point for an 8-hour requirement. The extra capacity (220 vs 176 raw) is the aging + temperature buffer.',
  ],
  outputLabel: 'Minimum sized battery string capacity',
  outputUnits: 'Ah',
  resultNote: (val) =>
    val >= 200
      ? `${val.toFixed(0)} Ah — valid design. Specify the next standard VRLA jar size above this value.`
      : `${val.toFixed(0)} Ah — check your inputs. At 22 A for 8 h with 0.80 de-rate the answer should be 220 Ah.`,
};

// ── Capstone Quiz Questions ────────────────────────────────────────────────
...
export default function T19L10_CapstoneQuiz() {
  return (
    <LessonLayout meta={meta}>

      <section data-tier="foundations">
        <h2>T19 Capstone Quiz — Headend / CO + Rack-Side Hardware</h2>
        <p>
          This quiz covers all of T19 (L01–L09). Questions draw on headend layout, OLT/CMTS architecture,
          –48 VDC power systems, battery backup, HVAC and fire suppression, OSP-to-ISP grounding at the
          building entry (PATH Y terms), ODF rack hardware, FOSC management, and FDH internals.
        </p>
        <p>
          <strong>15 questions.</strong> Score ≥ 80% (12 of 15) before proceeding to T14 Bonding,
          Grounding &amp; Electrical Protection, which builds on the PATH Y grounding vocabulary introduced
          in T19.L06.
        </p>
        <p>
          If any question stumps you, the explanation shows which T19 lesson to review. Come back and
          retake after reviewing — spaced repetition is how this material sticks.
        </p>
      </section>

      {/* ── Signal chain diagram — identify the elements ────────────────── */}
      <section data-tier="foundations">
        <h3>Signal Chain Review — Click Each Node</h3>
        <p>
      ...
      <section data-tier="foundations">
        <h3>Battery Sizing Review — Work Through This Before Question 4</h3>
        <p>
          Quiz question 4 asks about the battery sizing result. Use the interactive calculator below to work
          through the formula and verify your answer. The default values match the question scenario.
        </p>
        <WorkedExample
          title={batterySizingExample.title}
          description={batterySizingExample.description}
          variables={batterySizingExample.variables}
          formula={batterySizingExample.formula}
          steps={batterySizingExample.steps}
          outputLabel={batterySizingExample.outputLabel}
          outputUnits={batterySizingExample.outputUnits}
          resultNote={batterySizingExample.resultNote}
        />
      </section>
