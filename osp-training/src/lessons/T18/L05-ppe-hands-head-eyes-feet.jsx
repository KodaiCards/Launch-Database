// Net-new — T18.L05 PPE — Hands, Head, Eyes, Feet
// Foundation lesson: glove classes, hard hat classes, dielectric boots, hi-vis
...
export const meta = {
  id: 'T18.L05',
  course_id: 'T18',
  title: 'PPE — Hands, Head, Eyes, Feet',
  order: 5,
  ...
  key_terms: [
    ...
    },
    {
      ...
      definition:
        'Protective Personal Gloves — rubber insulating gloves rated by maximum-use voltage per 29 CFR 1910.137 and ASTM D120. Class 00: ≤500V AC. Class 0: ≤1,000V. Class 1: ≤7,500V. Class 2: ≤17,000V. Class 3: ≤26,500V. Class 4: ≤36,000V. The class tells you the maximum AC voltage the glove is rated to protect against.',
    },
    {
      term: 'ANSI Z89.1 Class E',
      definition:
        'Hard hat classification for electrical protection at up to 20,000 volts (phase-to-ground) per ANSI/ISEA Z89.1. Class E (Electrical) is required when working near energized distribution or transmission conductors. The "E" stands for Electrical.',
    },
    {
      term: 'ANSI Z89.1 Class G',
      definition:
        'Hard hat classification for general electrical protection at up to 2,200 volts (phase-to-ground) per ANSI/ISEA Z89.1. Suitable for most general construction work, but NOT for work near distribution-voltage energized conductors — use Class E instead.',
    },
    {
      term: 'dielectric boots',
      definition:
        'Electrical-hazard (EH) rated footwear that resists completing a circuit through the sole. Rated per ASTM F2412 (test method) and ASTM F2413 (performance specification). Required on OSP jobs where electrical contact hazard exists — linework, ground rod driving, work near energized conductors.',
    },
    {
      term: 'hi-vis vest',
      definition:
...
export default function T18L05_PPEHandsHeadEyesFeet() {
  return (
    <LessonLayout meta={meta}>
      ...
      <section data-tier="foundations">
        ...
        <p>
          PPE is the last layer in the hierarchy of controls — it doesn't reduce the hazard,
          it reduces the injury if the hazard is encountered. That makes correct PPE selection
          critical: the wrong glove class, a Class G hard hat where Class E is needed, or
          no hi-vis vest on a roadway job are not minor compliance details. They're the
          difference between walking away and not walking away from the incident you didn't see
          coming.
        </p>
        <p className="mt-2">
          This lesson covers the four body zones that PPE protects on an OSP job: hands, head,
          eyes, and feet. For each zone, you'll learn what the rating system means (not just
          which product to wear, but why), and — critically — the distinction between
          mechanical protection and electrical protection. Leather work gloves and rubber
          insulating gloves look similar in a truck toolbox. They are not the same thing.
        </p>
        ...
        <table className="w-full text-sm border border-white/10 rounded-lg mt-2">
          <thead className="bg-white/5 text-slate-200">
            <tr>
              <th className="px-3 py-2 text-left">Acronym/Standard</th>
              <th className="px-3 py-2 text-left">What it covers</th>
            </tr>
          </thead>
          <tbody className="text-slate-300/90">
            <tr className="border-t border-white/10">
              <td className="px-3 py-2 font-mono">ANSI Z89.1</td>
              <td className="px-3 py-2">Hard hat types (I/II) and classes (E/G/C) — electrical and impact ratings</td>
            </tr>
            <tr className="border-t border-white/10">
              <td className="px-3 py-2 font-mono">ASTM D120</td>
              <td className="px-3 py-2">Rubber insulating glove specification — Class 00 through Class 4 voltage ratings</td>
            </tr>
            <tr className="border-t border-white/10">
              <td className="px-3 py-2 font-mono">ASTM F2413</td>
              <td className="px-3 py-2">Foot protection performance standard — EH (electrical hazard) rating for boots</td>
            </tr>
            <tr className="border-t border-white/10">
            ...
            <tr className="border-t border-white/10">
              ...
              <td className="px-3 py-2">OSHA general PPE standard — employer must assess hazards and provide appropriate PPE at no cost to employees</td>
            </tr>
          </tbody>
        </table>

        <h3 className="mt-5 font-semibold">Employer duty: hazard assessment and cost</h3>
        <p className="mt-2">
          Under 29 CFR 1910.132(d)(1), the employer is required to assess the workplace for
          hazards and provide PPE appropriate to those hazards — at no cost to the employee.
          The worker's job is to wear it correctly and consistently. If PPE is provided but
          workers aren't using it, both the employer (for not enforcing) and the worker
          (for non-compliance with policy) face liability.
        </p>
        ...
        <Flashcard
          ...
          cards={[
            ...
            },
            {
              ...
              back: 'Class 1 rubber insulating gloves are rated for a maximum-use voltage of 7,500V AC (ASTM D120 / 29 CFR 1910.137). Use Class 1 when working within the minimum approach distance of conductors up to 7,500V phase-to-ground.',
            },
            {
              id: 'T18-L05-fc-class-e',
              front: 'What is an ANSI Z89.1 Class E hard hat?',
              back: 'A hard hat rated for electrical protection at up to 20,000 volts (phase-to-ground) per ANSI/ISEA Z89.1. Required when working near energized distribution or transmission conductors. Class E = Electrical (high-voltage protection).',
            },
            {
              id: 'T18-L05-fc-class-g',
              front: 'What is an ANSI Z89.1 Class G hard hat?',
              back: 'A hard hat rated for general electrical protection at up to 2,200 volts (phase-to-ground). Suitable for general construction, but NOT for work near distribution-voltage energized conductors — Class E (20,000V rated) is required for that.',
            },
            {
              id: 'T18-L05-fc-dboots',
              front: 'What are dielectric (EH-rated) boots?',
              back: 'Electrical-hazard rated footwear that resists completing a circuit through the sole. Rated per ASTM F2412/F2413. Required on OSP jobs where electrical contact hazard exists. The EH rating does not protect against direct immersion in live circuits — it protects against incidental ground contact near energized equipment.',
            },
            {
              id: 'T18-L05-fc-hivis',
              front: 'What hi-vis vest class is required for daytime roadway work?',
              back: 'ANSI/ISEA 107 Class 2 is the minimum for daytime roadway work. Class 3 is required for nighttime roadway work or high-speed (> 50 mph) traffic zones. Class 1 is for off-road environments with minimal vehicle traffic.',
            },
          ]}
        />
      </section>
      ...
      <section data-tier="working">
        ...
        <p className="mt-2">
          ...
          hazard types — and the gloves that protect against one provide zero protection
          against the other.
        </p>
        <div className="mt-3 space-y-3">
          <div className="p-3 bg-sky-400/10 border border-sky-400/20 rounded-lg text-sm">
            <p className="font-semibold text-sky-300">Leather work gloves</p>
            <p className="text-slate-300/90 mt-1">Protect against: cuts, abrasions, punctures, splinters, and grip loss. Used for: pulling cable, handling hardware, climbing with gaffs, running rope through conduit. These are mechanical protection only. They provide zero electrical insulation.</p>
          </div>
          <div className="p-3 bg-green-400/10 border border-green-400/20 rounded-lg text-sm">
            <p className="font-semibold text-green-300">Rubber insulating gloves (PPG Classes 00–4)</p>
            <p className="text-slate-300/90 mt-1">Protect against: electrical contact. Required when working within the minimum approach distance of energized conductors. Worn over a liner glove (to protect the rubber from puncture) and under a leather outer glove (for mechanical protection). The layered assembly is: liner → rubber insulating glove → leather protector.</p>
          </div>
        </div>

        <div className="mt-4 overflow-x-auto">
          <p className="text-sm font-semibold text-slate-200 mb-2">Rubber Insulating Glove Classes (29 CFR 1910.137 + ASTM D120)</p>
          <table className="w-full text-sm border border-white/10 rounded-lg">
            <thead className="bg-white/5 text-slate-200">
              <tr>
                <th className="px-3 py-2 text-left">Class</th>
                <th className="px-3 py-2 text-left">Max-use voltage (AC)</th>
                <th className="px-3 py-2 text-left">Typical OSP application</th>
              </tr>
            </thead>
            <tbody className="text-slate-300/90">
              <tr className="border-t border-white/10">
                <td className="px-3 py-2 font-mono">00</td>
                <td className="px-3 py-2">≤ 500V AC</td>
                <td className="px-3 py-2">Low-voltage equipment (battery hut 48V–480V systems)</td>
              </tr>
              <tr className="border-t border-white/10">
                <td className="px-3 py-2 font-mono">0</td>
                <td className="px-3 py-2">≤ 1,000V AC</td>
                <td className="px-3 py-2">Secondary service voltage work (up to 1kV)</td>
              </tr>
              <tr className="border-t border-white/10 bg-amber-400/5">
                <td className="px-3 py-2 font-mono">1</td>
                <td className="px-3 py-2">≤ 7,500V AC</td>
                <td className="px-3 py-2">Distribution voltages up to 7.5 kV (common on rural RUS joint-use poles)</td>
              </tr>
              <tr className="border-t border-white/10 bg-amber-400/5">
                <td className="px-3 py-2 font-mono">2</td>
                <td className="px-3 py-2">≤ 17,000V AC</td>
                <td className="px-3 py-2">Distribution voltages up to 17 kV (e.g., 14.4 kV phase-to-ground on 25 kV three-phase)</td>
              </tr>
              <tr className="border-t border-white/10">
                <td className="px-3 py-2 font-mono">3</td>
                <td className="px-3 py-2">≤ 26,500V AC</td>
                <td className="px-3 py-2">Transmission-level distribution (uncommon on OSP work)</td>
              </tr>
              <tr className="border-t border-white/10">
                <td className="px-3 py-2 font-mono">4</td>
                <td className="px-3 py-2">≤ 36,000V AC</td>
                <td className="px-3 py-2">High-voltage transmission (qualified lineman work — NOT typical OSP)</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div className="mt-4 p-4 border border-amber-400/30 bg-amber-400/5 rounded-lg text-sm">
          <p className="font-semibold text-amber-300 mb-1">Book vs. Field — The Glove Substitution Mistake</p>
          <p className="text-slate-300/90">
            <strong>Book (1910.268 and 1910.137):</strong> Rubber insulating gloves are required
            when working within the minimum approach distance of energized conductors. The class
            is selected based on the maximum voltage at the work site.
          </p>
          <p className="text-slate-300/90 mt-2">
            <strong>Field reality:</strong> Most OSP and telecom crew members wear leather work
            gloves for all daily tasks — pulling cable, handling hardware, climbing. Leather is
            the right choice for those tasks. The dangerous pattern happens when a crew member
            is near an energized conductor and says "I've got my gloves on" — meaning their
            leather work gloves. Leather work gloves provide ZERO electrical protection.
            Substituting leather for rubber insulating gloves when energized conductors are within
            reach is a potentially fatal mistake. The two glove types look similar. They are not.
          </p>
        </div>

        <h3 className="mt-5 font-semibold">HEAD — Hard Hat Classes</h3>
        <p className="mt-2">
          Hard hats under ANSI/ISEA Z89.1 are rated for both impact and electrical protection.
          The class letter is the electrical rating:
        </p>
        <ul className="list-disc pl-5 space-y-2 mt-2 text-sm text-slate-300/90">
          <li>
            <strong>Class E (Electrical) — 20,000V:</strong> Required when working on joint-use
            poles where overhead distribution conductors are within the work area. The "E" rating
            means the hat has been tested at 20,000 volts without conducting current through to
            the head.
          </li>
          <li>
            <strong>Class G (General) — 2,200V:</strong> Minimum for most construction and
            utility work. NOT sufficient for work near distribution-voltage (7,200V–25,000V)
            energized conductors.
          </li>
          <li>
            <strong>Class C (Conductive) — no electrical protection:</strong> Do NOT wear near
            any energized conductor. Often metallic or vented designs; widely used in foundry
        ...
        <p className="mt-2">
          ...
          wire cutting, conduit cutting, strand installation, fiber cleaving, and drilling. The
          Z87.1 marking on the lens confirms impact resistance testing. Clear safety glasses
          (impact only) are the baseline; tinted lenses for sun exposure; side shields where
          flying debris is likely. Ordinary prescription glasses do NOT meet Z87.1 unless they
          bear the marking. A face shield over safety glasses is required for grinding and heavy
          cutting operations.
        </p>
      ...
      <section data-tier="advanced">
        <h2>PPE Inspection and Maintenance — When Gear Fails You</h2>
        <p>
          PPE that has been compromised provides false confidence — worse, in some cases, than
          knowing you have no protection. Three critical inspection points for OSP PPE:
        </p>
        <ul className="list-disc pl-5 space-y-2 mt-2 text-sm text-slate-300/90">
          <li>
          ...
          <li>
            ...
            deformation. Check the suspension (the internal cradle) for cracking or broken
            loops. Replace after any significant impact — even if no damage is visible. Never
            paint, drill, or apply solvents to a hard hat; they degrade the shell's electrical
            and impact properties. Replace every 2 years (suspension) to 5 years (shell) or per
            manufacturer guidance.
          </li>
          <li>
            <strong>Safety harnesses and lanyards:</strong> Inspect stitching for fraying,
            webbing for cuts or abrasion, hardware for corrosion or deformation before every
            use. If a harness or lanyard has arrested a fall, retire it immediately — even if
            it looks undamaged. The energy-absorbing elements have been used and may not perform
            again.
          </li>
        </ul>
      </section>
      ...
      <Sortable
        title="Sort PPE by the Hazard It Primarily Protects Against"
        prompt="Drag these PPE items into order from the hazard that requires the MOST specialized PPE (top) to general utility PPE (bottom). Correct order reflects electrical → impact/struck-by → visibility → mechanical sequence."
        items={[
          { id: 'rubber-gloves', label: 'Class 2 rubber insulating gloves' },
          { id: 'class-e-hat', label: 'ANSI Z89.1 Class E hard hat' },
          { id: 'hivis-class3', label: 'Class 3 hi-vis vest' },
          { id: 'safety-glasses', label: 'ANSI Z87.1 safety glasses' },
          { id: 'leather-gloves', label: 'Leather work gloves' },
        ]}
        correctOrder={['rubber-gloves', 'class-e-hat', 'hivis-class3', 'safety-glasses', 'leather-gloves']}
        explanation="Rubber insulating gloves and Class E hard hats address the most specific and lethal hazard — energized electrical conductors. Class 3 hi-vis addresses the struck-by-vehicle hazard. Safety glasses address impact/particulate hazards for the eyes. Leather work gloves address the broadest category — mechanical protection for everyday tasks. Note: all items in this list are required together on appropriate job sites — the sort order reflects hazard specificity, not importance."
        citation="29 CFR 1910.137 (rubber insulating gloves); 29 CFR 1910.268(b) (PPE table for telecom); ANSI Z89.1 (hard hat classes); ANSI/ISEA 107 (hi-vis classes); ASTM D120 (glove class ratings)."
        fieldNote="The sort order isn't meant to suggest any PPE is 'less important.' On a joint-use pole job in a roadway, you need every one of these at the same time."
      />
