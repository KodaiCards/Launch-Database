      ...
      <section data-tier="foundations">
        ...
        <Flashcard
          ...
          cards={[
            ...
            { id: 'T05-L08-fc-poleowner', front: 'What is a pole owner and what responsibilities do they have?', back: 'The utility or municipality that physically owns the poles in a corridor. Most poles in the US are owned by the local electric utility or telephone company. The pole owner sets attachment rates (within FCC limits), approves or denies attachment applications, and performs or coordinates make-ready. The pole owner is also responsible for the structural integrity of the pole itself.' },
            { id: 'T05-L08-fc-attacher', front: 'What is an attacher?', back: 'Any entity that places a cable, equipment, or hardware on a pole it does not own. Common attachers: cable TV providers (CATV), fiber internet providers (ISPs/CLECs), telephone companies (ILECs), and municipal networks. Attachers must have an executed attachment agreement with the pole owner before placing any hardware.' },
            { id: 'T05-L08-fc-attachfee', front: 'What is an attachment fee and how are the rates regulated?', back: 'The annual per-pole fee an attacher pays the pole owner for the right to occupy space on the pole. FCC rules at 47 CFR Part 1, Subpart J set the maximum rates a regulated pole owner can charge for telecommunications attachments. Rates vary by attacher type: telecom attachers typically pay a lower rate than cable TV attachers under the "fully allocated cost" vs. "telecom formula" distinction.' },
            { id: 'T05-L08-fc-ilec', front: 'What is an ILEC?', back: 'Incumbent Local Exchange Carrier — the original local telephone company in a given area (typically AT&T, CenturyLink/Lumen, Frontier, or a rural RLEC). ILECs often own poles in areas where the telephone company built before the electric utility. When the ILEC owns the pole, the electric utility becomes the attacher.' },
            { id: 'T05-L08-fc-clec', front: 'What is a CLEC and why does the classification matter for attachment fees?', back: 'Competitive Local Exchange Carrier — a telephone company that competes with the incumbent local telephone company in a given area. CLECs (including fiber ISPs operating as CLECs) may be entitled to lower FCC-regulated attachment rates than CATV providers. The CLEC designation matters for determining which FCC attachment rate formula applies.' },
          ]}
        />
      </section>
