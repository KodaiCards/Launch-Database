      ...
      <section data-tier="foundations">
        ...
        <Flashcard
          ...
          cards={[
            ...
            { id: 'T05-L02-fc-table232-1', front: 'What is Table 232-1 and what does it contain?', back: 'The lookup table inside NESC Rule 232 that lists the specific minimum clearance distances for each crossing type (road with traffic, pedestrian-only area, railroad, navigable water, and others). Values are paywalled in the NESC C2-2023 document; secondary sources confirm approximately 15.5 ft for traffic lanes and 9.5 ft for pedestrian-only areas.' },
            { id: 'T05-L02-fc-pedestrian-clearance', front: 'What is the minimum vertical clearance for a communication cable over a pedestrian-only area?', back: 'The minimum vertical clearance above areas accessible only to pedestrians (no vehicle access). Per public secondary sources summarizing NESC Table 232-1, communication cables over pedestrian-only areas require approximately 9.5 ft. Confirm from NESC C2-2023 Table 232-1.' },
            { id: 'T05-L02-fc-grade-b-crossing', front: 'What is a Grade B crossing and when is it required?', back: 'A crossing classified under NESC Rule 261 as requiring the highest structural safety factors. Grade B is mandatory for crossings over railroads, limited-access highways, and navigable waterways. Grade B crossings require higher load and strength factors than standard Grade C construction.' },
          ]}
        />
      </section>
