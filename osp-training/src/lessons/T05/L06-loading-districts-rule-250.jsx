      ...
      <section data-tier="foundations">
        ...
        <Flashcard
          ...
          cards={[
            ...
            { id: 'T05-L06-fc-loadingdistrict', front: 'What is a loading district?', back: 'A geographic zone in the NESC Rule 250 map that specifies the design ice thickness, wind pressure, and temperature combination that aerial structures in that zone must be designed to withstand. There are four main districts: Light, Medium, Heavy, and Extreme Wind (Rule 250C). The district determines what weather loads go into every structural calculation for your design.' },
            { id: 'T05-L06-fc-medium', front: 'State the design loads for the NESC Medium loading district.', back: 'NESC loading district with 0.25 inches of radial ice, 4 psf wind pressure (approximately 40 mph), and +15°F design temperature. Applies to an intermediate band across the mid-Atlantic and central US. Ice and wind combine in calculations.' },
            { id: 'T05-L06-fc-extremewind', front: 'What is the Extreme Wind loading district?', back: 'NESC Rule 250C overlay applied to structures 60 feet or more above ground in mapped high-wind coastal zones (Atlantic coast, Gulf of Mexico coast, and Pacific coast). No ice component, but wind pressure is determined from a site-specific map (ranging from roughly 90 to 150 mph depending on location). Rule 250C can apply in addition to the base district.' },
            { id: 'T05-L06-fc-rule250', front: 'What does NESC Rule 250 define?', back: 'The NESC rule that defines the loading districts (250B for Heavy/Medium/Light, 250C for Extreme Wind, 250D for Extreme Ice with Concurrent Wind) and specifies the design ice, wind, and temperature values for each. Rule 250 is where you look up what loads to put into your structural calculations.' },
            { id: 'T05-L06-fc-radialice', front: 'What is radial ice thickness?', back: 'The thickness of ice that builds up uniformly around a cable during an ice storm, expressed in inches. Radial means equal in all directions — an ice sleeve forming a ring around the cable. Heavy district = 0.50 in radial. Medium = 0.25 in radial. Light = 0 in (no ice). The iced cable OD = original OD + (2 × radial ice thickness).' },
            { id: 'T05-L06-fc-250d', front: 'What is the Extreme Ice with Concurrent Wind requirement (Rule 250D)?', back: 'NESC Rule 250D requirement that applies to localized areas with historically severe ice storms (mostly central and eastern US). Uses a 50-year return-period ice map combined with a concurrent reduced wind load. Rule 250D areas are identified on the NESC C2-2023 map.' },
          ]}
        />
      </section>
