  ...
  return (
    <LessonLayout meta={meta}>
      ...
      <section data-tier="advanced">
        ...
        <h3 className="mt-5 font-semibold">OSHA 1910.268: Telecom-Specific Regulations</h3>
        <div className="rounded bg-white/5 p-3 mt-3 text-sm space-y-1 text-slate-300/90">
          <p>OSHA 1910.268 covers telecommunications operations specifically. Key provisions field fiber technicians encounter:</p>
          <ul className="list-disc pl-5 space-y-1 mt-2">
            <li><strong>Pole climbing:</strong> Fall protection (body harness + lanyard) required when climbing above 6 ft on utility poles, except during emergency ascent/descent.</li>
            <li><strong>Joint-use pole clearances:</strong> Minimum clearances from energized power lines per NESC. Field crew must know the voltage class before working near any line.</li>
            <li><strong>Manhole entry (1910.268(o)):</strong> Atmospheric testing required before entry. O₂ must be ≥19.5%. Explosive gases must be &lt;10% LEL. A standby person required outside.</li>
            <li><strong>Rescue plan (1910.268(g)):</strong> A written rescue plan must be in place before any confined space entry. Names the rescuer, identifies rescue equipment (rope, harness).</li>
            <li><strong>Cable sheath bonding:</strong> Cable sheaths and metallic strength members must be bonded at terminal points to prevent shock from induced voltage.</li>
          </ul>
        </div>

        <h3 className="mt-5 font-semibold">Job Hazard Analysis (JHA)</h3>
        <p className="text-sm text-slate-300/90 mt-2">
          A JHA breaks down each task step and identifies hazards before work begins. Required on most RUS and large telecom projects before construction starts.
        </p>
        <table className="w-full text-sm border border-white/10 rounded-lg mt-3">
          <thead className="bg-white/5 text-slate-200">
            <tr>
              <th className="px-3 py-2 text-left">Task step</th>
              <th className="px-3 py-2 text-left">Hazard</th>
              <th className="px-3 py-2 text-left">Control measure</th>
            </tr>
          </thead>
          <tbody className="text-slate-300/90 text-xs">
            <tr className="border-t border-white/10">
              <td className="px-3 py-2">Open utility vault</td>
              <td className="px-3 py-2">Gas accumulation, oxygen deficiency</td>
              <td className="px-3 py-2">Atmospheric test before entry; forced air ventilation; competent person stationed outside</td>
            </tr>
            <tr className="border-t border-white/10">
              <td className="px-3 py-2">Work near joint-use pole with power</td>
              <td className="px-3 py-2">Electrical contact, arc flash</td>
              <td className="px-3 py-2">Maintain NESC clearances; verify voltage class; rubber insulating equipment if within 10 ft of primary</td>
            </tr>
            <tr className="border-t border-white/10">
              <td className="px-3 py-2">Pull cable through conduit</td>
              <td className="px-3 py-2">Back strain from winch, hand injuries from grip</td>
              <td className="px-3 py-2">Use mechanical winch; never hand-pull with rope wrapped around hands; keep hands clear of grip</td>
            </tr>
            <tr className="border-t border-white/10">
              <td className="px-3 py-2">Cleave fiber in the field</td>
              <td className="px-3 py-2">Fiber shards in eye or skin</td>
              <td className="px-3 py-2">Safety glasses always; collect cleaved ends on a sticky-tape "sharps" mat; no eating at work surface</td>
            </tr>
            <tr className="border-t border-white/10">
              <td className="px-3 py-2">Set up roadside traffic control</td>
              <td className="px-3 py-2">Vehicle strikes crew or equipment</td>
              <td className="px-3 py-2">Traffic control plan per MUTCD; flaggers; cones and signage at 300 ft advance warning</td>
            </tr>
          </tbody>
        </table>

        <h3 className="mt-5 font-semibold">Worked Scenario: Confined Space Incident</h3>
        <div className="rounded bg-white/5 p-3 mt-3 text-sm space-y-2 text-slate-300/90">
          <p><strong>Situation:</strong> A splice crew opens a utility vault in an urban area. The first technician descends without atmospheric testing — the crew ran out of time before the scheduled maintenance window closed. At 8 ft depth, the technician becomes dizzy and collapses.</p>
          <p><strong>Root cause:</strong> The vault had accumulated CO₂ from nearby organic decomposition. Oxygen measured 16.2% — below the OSHA threshold of 19.5%.</p>
          <p><strong>Outcome:</strong> The standby technician (outside) activated the rescue plan and retrieved the first technician with a retrieval harness. No fatality; technician recovered. OSHA investigation cited the company for failure to test the atmosphere before entry (1910.268(o)) and failure to have a written rescue plan in place (1910.268(g)).</p>
          <p><strong>Exam relevance:</strong> This scenario appears directly on CFOT. Know: minimum O₂ = 19.5%, written rescue plan required before entry, competent person stationed outside. These are not optional — they are the difference between a workday and a fatality.</p>
        </div>
      </section>
      ...
      <section className="mt-8 rounded-lg bg-slate-800/40 border border-slate-700 p-4">
        ...
        <p className="text-sm text-slate-300/90 mt-2">
          You first encountered safety principles in <strong>T18</strong> (Safety Fundamentals). This lesson adds the CFOT exam layer: specific OSHA regulations, the PPE table for fiber environments, and confined-space rules that cost companies thousands in fines when skipped.
          For the exam, OSHA 1910.268 (telecom) and 1910.146 (confined space) are the two most frequently cited standards. Know the minimum O₂ percentage (19.5%), the rescue plan requirement (1910.268(g)), and the LOTO procedure: de-energize → lock → tag → verify zero energy.
          In the field, no shortcut is worth an incident. A single OSHA recordable triggers an investigation, fines, higher workers comp premiums, and — for RUS contractors — potential loss of bonding eligibility for federal projects. Prevention is far cheaper than remediation.
        </p>
      </section>
