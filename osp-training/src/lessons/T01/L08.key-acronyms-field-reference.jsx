    ...
    <LessonLayout meta={meta}>
      ...
      <Flashcard
        ...
        cards={[
          ...
          { id: 'T01-L08-FC-hdpe', front: 'HDPE', back: 'High-Density Polyethylene — a rigid thermoplastic used for OSP conduit and cable outer jackets. Resists UV radiation, moisture, and chemical exposure. OSP fiber conduit is typically Schedule 40 PVC or HDPE; innerduct inside conduit is often corrugated HDPE.' },
          ...
          { id: 'T01-L08-FC-lidar', front: 'LiDAR', back: 'Light Detection and Ranging — remote sensing technology using pulsed laser light to measure distances and create 3D point clouds. Drone-mounted LiDAR is used for pole height measurement, vegetation clearance analysis, and route surveys.' },
          { id: 'T01-L08-FC-ftth', front: 'FTTH', back: 'Fiber to the Home — a network architecture where dedicated fiber runs from a central office or hub all the way to an individual residence. Provides the highest bandwidth per customer of any broadband technology.' },
          { id: 'T01-L08-FC-xgs-pon', front: 'XGS-PON', back: '10 Gigabit Symmetric Passive Optical Network — next-generation PON standard delivering 10 Gb/s both downstream and upstream over the same passive optical infrastructure as GPON. Gaining adoption in new FTTH deployments.' },
          { id: 'T01-L08-FC-ppe', front: 'PPE', back: 'Personal Protective Equipment — hard hat, safety glasses, gloves, high-visibility vest, steel-toed boots at minimum for any field work. Additional PPE (face shield, FR clothing, dielectric gloves) required for specific hazard exposures.' },
          { id: 'T01-L08-FC-nhpa', front: 'NHPA', back: 'National Historic Preservation Act — Section 106 requires review of potential impacts on historic properties before federally funded projects proceed. Involves coordination with State Historic Preservation Officer (SHPO) and Tribal Historic Preservation Officer (THPO).' },
          { id: 'T01-L08-FC-esa', front: 'ESA', back: 'Endangered Species Act — Section 7 consultation required for federally funded projects affecting listed species or critical habitat. FWS IPaC (Information, Planning, and Conservation) tool is used to identify ESA concerns in a project area.' },
        ]}
      />
