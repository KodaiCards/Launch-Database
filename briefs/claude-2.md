...
**Status:** R15.1 DONE — ready for CEO review. R14 MERGED ✓ 2026-06-24. Map view rebuilt: Leaflet overview map (Macon-centered, status-colored pins, boundary polygons, markercluster), SA list sidebar synced to map, CC/estimate in toggle drawer.
