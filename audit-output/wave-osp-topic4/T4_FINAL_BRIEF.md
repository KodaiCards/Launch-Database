...
| 4.14 | RUS/USDA Bulletins | 1751F-630 (aerial, §1); 1751F-635 (underground, §1); 1715E-110 (design guide); Form 219 approval chain. Deliverable matrix scenario. Duration: 30 min (up from 25 per B §3 + CLAUDE.md RUS-primary framing) | 30 min | HIGH-INTENSITY | 1751F-630 (aerial); 1751F-635 (underground); 1715E-110; Form 219; 7 CFR Part 1755 — Telecommunications Loan Program (Subpart D for OSP construction); the regulatory authority anchoring the RUS 1751F bulletin series / BICSI OSP-DRD Ch. 2.9; ANSI/TIA-758-C / All listed | Flashcards + scenario (RUS aerial + conduit project: map bulletin, form, close-out sequence) | 48-count SM aerial + conduit route, RUS funds — bulletin selection, Form 219 triggers, drawing deadline, close-out package |
...
- **Pass threshold:** 23/32 (70%) — math: 32 × 0.70 = 22.4 → round up to 23 (cannot have fractional questions); 23/32 = 71.875%
