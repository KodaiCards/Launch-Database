...
- **NEC Article 770** — Optical Fiber Cables and Raceways. Key sections: **§770.26 — Establishing Corrosion Preventive Status** (OSP-rated cable: OFNR/OFNP/OFNRX/OFNPX max 50 ft inside building before transition to indoor-rated (OFNR-2/OFNP-2) or continuous conduit). Scope: T19.L01 (building-layout awareness) + T19.L08 (cable-entry demarc lesson objective). Public eCFR at https://www.ecfr.gov/current/title-47/subtitle-B/chapter-I/subchapter-B/part-68 (references NEC 770 compliance). [ADDED 2026-05-16 per R-2 gap finding]
