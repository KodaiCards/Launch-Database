...
| "Aerial lifts (bucket trucks): 29 CFR 1910.67(c)(2)(v) requires a personal fall arrest system OR travel restraint system worn and attached to the boom or basket while in lift" | 29 CFR 1910.67(c)(2)(v) (ecfr.gov; osha.gov) — VERIFIED; current text says 'personal fall arrest or travel restraint system' — body harness is one valid option under PFAS, but travel restraint system is also acceptable; do NOT state 'body harness required' |
...
| "Advance warning sign spacing: MUTCD Part 6 Table 6C-1 provides fixed spacing distances by road type — approximately 100–350 ft for urban/suburban, 500 ft for rural, 1,000+ ft for expressways/freeways. FHWA guidance range for spacing between signs in the advance warning area: 4–8× speed limit (mph) → ft for urban, 8–12× for rural (engineering judgment applies)" | MUTCD 11th Edition (2023) Part 6, Table 6C-1 (mutcd.fhwa.dot.gov) — VERIFIED free public source; heuristic range per FHWA guidance text (not a MUTCD formula — do not cite as formula) |
