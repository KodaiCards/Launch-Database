...
- **STATUS: on branch `redesign/theme-picker` (NOT yet on main).** Main auto-deploys to prod → merging flips the whole team to dark + the new topbar, so **holding for Carter's deploy go.**
