...
| 07 | **Billing/invoices/money** | billing, billing_keystone, invoices, invoice_templates, revenue, projections, project_billing, pricing, budgets + invoice_generator/template_engine | P2 | 🔄 `07-billing.md` (07a engines O15 RESOLVED/O16/O19 · 07b invoice-PDF stack: **O20** RUS-PDF is legacy-only = #1 cutover blocker, **I5** configurable template engine exists. Pending 07c revenue/projections/budgets/pricing/project_billing) |
