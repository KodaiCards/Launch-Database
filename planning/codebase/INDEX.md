...
| 09 | **Hours/time** (TRUST-CRITICAL) | time_entries, hours_csv, hours_import, _hours_match + timeclock_module.js | P2 | 🔄 `09-hours.md` (09a: **O22** silent round-to-0.25 every write; **O23** hours split-brain legacy project_id ⟂ keystone service_area_job_id = likely root of "don't trust hours"; _hours_match=keystone matcher. Pending 09b importers, 09c timeclock) |
