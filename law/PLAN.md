...
| 2.6 | **System D hours** — manual-entry-first UX; three attribution targets (job / **area-WO** / overhead); 1099 mobile app = **one flow: clock-in + daily card** (I-1); Workforce CSV import (sample `*`); confirm loop + anomalies | specs/hours.md | **RATIFIED 2026-07-13** (two-source truth: in-app=billing, Workforce CSV=payroll, leftover=UNBILLED; append-only + change requests) — after 2.3 |
