...
| **#86 one-time xfm backfill sweep** (Carter 2026-07-20) — consolidated cross-foreman user playthrough of System F pages/flows (#73/#74/#75/#76), post-#70 admin, themes (#69/#72), /verify (#67); runs in preview vs `main` (NOT prod); one `bug` per finding. `needs-xfm` label created. | open #86 | active — claim by an eligible foreman (author≠driver) / VO-covers on solo weeks |
